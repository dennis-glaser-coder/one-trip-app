/* NOREYO V10.93 bootstrap — V10.91 plus Safari input auto-zoom prevention. */
(()=>{
'use strict';
const BUILD='10.93-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1093_SINGLE_FLIGHT__';
...
function src(b,a){return a<=1?b:b+(b.includes('?')?'&':'?')+'noreyo_v1093_retry='+a;}
...
window.NOREYO_V1093=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{});
})();