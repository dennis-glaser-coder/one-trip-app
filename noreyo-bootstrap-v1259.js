/* NOREYO V12.59 bootstrap — V12.57 plus remaining iPhone touch-floor completion. */
(()=>{
'use strict';
const BUILD='12.59-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1259_SINGLE_FLIGHT__';
const COMPONENTS=Object.freeze([
  ...
  {name:'Filter footer safe area V12.56',src:'./noreyo-v1256.js?build=1256',ready:()=>window.NOREYO_V1256?.BUILD==='12.56'},
  {name:'Remaining phone touch floor V12.58',src:'./noreyo-v1258.js?build=1258',ready:()=>window.NOREYO_V1258?.BUILD==='12.58'}
]);
...
function src(base,attempt){return attempt<=1?base:base+(base.includes('?')?'&':'?')+'noreyo_v1259_retry='+attempt}
...
window.NOREYO_V1259=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{});
})();