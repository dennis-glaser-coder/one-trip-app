/* NOREYO V7.08 bootstrap — retains V7.07 safety and adds truthful meal-plan priority copy after the generated app loads. */
(()=>{
'use strict';
const BUILD='7.08-safe',GUARD='./noreyo-v705.js?build=705',FAVORITES='./noreyo-v703.js?build=703',RANKING='./noreyo-v707.js?build=707',PRIORITY='./noreyo-v708.js?build=708',VIEWPORT='./noreyo-v702.js?build=702',BASE='./noreyo-bootstrap-v698.js?build=708';
...
window.NOREYO_BOOTSTRAP_PRELOAD=Object.freeze({BUILD,GUARD,FAVORITES,RANKING,PRIORITY,VIEWPORT,BASE,armDocumentWriteInjection});
boot();
})();
