/* NOREYO V7.07 bootstrap — installs symmetric request integrity, full favorite rollback, strict MUST/WISH ranking and final Safari viewport arbitration after the generated app loads. */
(()=>{
'use strict';
const BUILD='7.07-safe',GUARD='./noreyo-v705.js?build=705',FAVORITES='./noreyo-v703.js?build=703',RANKING='./noreyo-v707.js?build=707',VIEWPORT='./noreyo-v702.js?build=702',BASE='./noreyo-bootstrap-v698.js?build=707';
...
window.NOREYO_BOOTSTRAP_PRELOAD=Object.freeze({BUILD,GUARD,FAVORITES,RANKING,VIEWPORT,BASE,armDocumentWriteInjection});
boot();
})();
