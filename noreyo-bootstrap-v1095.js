/* NOREYO V10.95 bootstrap — V10.93 plus verify expiry/change-acceptance gate. */
(()=>{
'use strict';
const BUILD='10.95-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1095_SINGLE_FLIGHT__';
...
function src(b,a){return a<=1?b:b+(b.includes('?')?'&':'?')+'noreyo_v1095_retry='+a;}
...
window.NOREYO_V1095=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{});
})();