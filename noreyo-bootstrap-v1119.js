/* NOREYO V11.19 bootstrap — V11.17 plus final PREBOOK cancellation-policy truth. */
(()=>{
'use strict';
const BUILD='11.19-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1119_SINGLE_FLIGHT__';
const COMPONENTS=Object.freeze([
  ...
  {name:'Flight verify accessibility V10.98',src:'./noreyo-v1098.js?build=1098',ready:()=>window.NOREYO_V1098?.BUILD==='10.98'},
  {name:'Flight verify controls V11.00',src:'./noreyo-v1100.js?build=1100',ready:()=>window.NOREYO_V1100?.BUILD==='11.00'},
  {name:'Flight verify route V11.02',src:'./noreyo-v1102.js?build=1102',ready:()=>window.NOREYO_V1102?.BUILD==='11.02'},
  {name:'Hotel no availability V11.04',src:'./noreyo-v1104.js?build=1104',ready:()=>window.NOREYO_V1104?.BUILD==='11.04'},
  {name:'Hotel PREBOOK V11.06',src:'./noreyo-v1106.js?build=1106',ready:()=>window.NOREYO_V1106?.BUILD==='11.06'},
  {name:'Hotel PREBOOK lifecycle V11.08',src:'./noreyo-v1108.js?build=1108',ready:()=>window.NOREYO_V1108?.BUILD==='11.08'},
  {name:'Hotel PREBOOK route V11.10',src:'./noreyo-v1110.js?build=1110',ready:()=>window.NOREYO_V1110?.BUILD==='11.10'},
  {name:'Hotel PREBOOK price delta V11.12',src:'./noreyo-v1112.js?build=1112',ready:()=>window.NOREYO_V1112?.BUILD==='11.12'},
  {name:'Hotel PREBOOK acknowledgement V11.14',src:'./noreyo-v1114.js?build=1114',ready:()=>window.NOREYO_V1114?.BUILD==='11.14'},
  {name:'Hotel PREBOOK acknowledgement stabilizer V11.16',src:'./noreyo-v1116.js?build=1116',ready:()=>window.NOREYO_V1116?.BUILD==='11.16'},
  {name:'Hotel PREBOOK cancellation truth V11.18',src:'./noreyo-v1118.js?build=1118',ready:()=>window.NOREYO_V1118?.BUILD==='11.18'}
]);
...
function src(base,attempt){return attempt<=1?base:base+(base.includes('?')?'&':'?')+'noreyo_v1119_retry='+attempt}
...
window.NOREYO_V1119=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{})
})();