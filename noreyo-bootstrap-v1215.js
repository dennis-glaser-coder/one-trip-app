/* NOREYO V12.15 bootstrap — V12.13 plus stale callback-copy cleanup. */
(()=>{
'use strict';
const BUILD='12.15-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1215_SINGLE_FLIGHT__';
...
function src(base,attempt){return attempt<=1?base:base+(base.includes('?')?'&':'?')+'noreyo_v1215_retry='+attempt}
...
window.NOREYO_V1215=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{})
})();