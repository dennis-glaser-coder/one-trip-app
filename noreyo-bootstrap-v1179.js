/* NOREYO V11.79 bootstrap — V11.77 plus authenticated PREBOOK ownership transport. */
(()=>{
'use strict';
const BUILD='11.79-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1179_SINGLE_FLIGHT__';
...
function src(base,attempt){return attempt<=1?base:base+(base.includes('?')?'&':'?')+'noreyo_v1179_retry='+attempt}
...
window.NOREYO_V1179=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{})
})();