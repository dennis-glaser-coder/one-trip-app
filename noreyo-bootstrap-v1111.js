/* NOREYO V11.11 bootstrap — V11.09 plus hotel PREBOOK route integrity. */
(()=>{
'use strict';
const BUILD='11.11-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1111_SINGLE_FLIGHT__';
...
function src(base,attempt){return attempt<=1?base:base+(base.includes('?')?'&':'?')+'noreyo_v1111_retry='+attempt}
...
window.NOREYO_V1111=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{})
})();