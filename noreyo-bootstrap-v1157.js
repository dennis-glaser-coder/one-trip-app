/* NOREYO V11.57 bootstrap — V11.55 plus provider-binding-aware booking-form reconciliation. */
(()=>{
'use strict';
const BUILD='11.57-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1157_SINGLE_FLIGHT__';
const COMPONENTS=Object.freeze([
  ...
  {name:'Booking PII BFCache scrub V11.54',src:'./noreyo-v1154.js?build=1154',ready:()=>window.NOREYO_V1154?.BUILD==='11.54'},
  {name:'Booking form binding UI V11.56',src:'./noreyo-v1156.js?build=1156',ready:()=>window.NOREYO_V1156?.BUILD==='11.56'}
]);
...
function src(base,attempt){return attempt<=1?base:base+(base.includes('?')?'&':'?')+'noreyo_v1157_retry='+attempt}
...
window.NOREYO_V1157=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{})
})();