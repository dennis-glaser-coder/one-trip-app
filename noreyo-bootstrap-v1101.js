/* NOREYO V11.01 bootstrap — V10.99 plus mobile-safe flight verify controls. */
(()=>{
'use strict';
const BUILD='11.01-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1101_SINGLE_FLIGHT__';
...
function src(b,a){return a<=1?b:b+(b.includes('?')?'&':'?')+'noreyo_v1101_retry='+a;}
...
window.NOREYO_V1101=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{});
})();