/* NOREYO V7.98 — atomic traveller reconciliation on expanded child vocabulary. */
(function(){
'use strict';
const BUILD='7.98',MAX_ADULTS=6,MAX_CHILDREN=4,MAX_TRAVELLERS=9;
...
function derived(text){try{return window.NOREYO_V796?.derive?.(text)||null;}catch(_){return null;}}
function parsedAges(text){try{const v=window.NOREYO_V795?.groupedChildAges?.(text);return Array.isArray(v)?v.slice():null;}catch(_){return null;}}
...
window.NOREYO_V798=Object.freeze({BUILD,MAX_ADULTS,MAX_CHILDREN,MAX_TRAVELLERS,current,derived,parsedAges,valid,plan,equal,apply,reconcile,onApply});
})();