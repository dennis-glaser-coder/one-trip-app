...
ok=a.upgradeCapturedTerms()===false&&a.sync()===true&&!ctx.window.NOREYO_HOTEL_PREBOOK_TERMS;
console.log(ok?'PASS existing prebook ownership is never relabelled to a new session':'FAIL new-session');if(!ok)fail++;
