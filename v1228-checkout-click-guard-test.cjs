...
let prevented=0,stopped=0,immediate=0,listeners={};const ctx={console,Object,window:{addEventListener(){}},document:{addEventListener(type,fn){listeners[type]=fn},removeEventListener(){},createElement(){return{textContent:'',hidden:false,setAttribute(){}}}};
