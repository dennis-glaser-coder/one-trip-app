/* NOREYO V10.99 bootstrap — V10.97 plus accessible live-verify announcements. */
(()=>{
'use strict';
const BUILD='10.99-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1099_SINGLE_FLIGHT__';
...
function src(b,a){return a<=1?b:b+(b.includes('?')?'&':'?')+'noreyo_v1099_retry='+a;}
...
window.NOREYO_V1099=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{});
})();