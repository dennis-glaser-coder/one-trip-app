/* NOREYO V7.04 bootstrap — installs full request integrity, full favorite rollback and final Safari viewport arbitration after the generated app loads. */
(()=>{
'use strict';
const BUILD='7.04-safe',GUARD='./noreyo-v704.js?build=704',FAVORITES='./noreyo-v703.js?build=703',VIEWPORT='./noreyo-v702.js?build=702',BASE='./noreyo-bootstrap-v698.js?build=704';
