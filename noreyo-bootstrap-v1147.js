/* NOREYO V11.47 bootstrap — V11.45 plus session-only hotel booking-data preparation. */
(()=>{
'use strict';
const BUILD='11.47-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1147_SINGLE_FLIGHT__';
...
function src(base,attempt){return attempt<=1?base:base+(base.includes('?')?'&':'?')+'noreyo_v1147_retry='+attempt}
...
window.NOREYO_V1147=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{})
})();