/* NOREYO V11.07 bootstrap — V11.05 plus server-side hotel PREBOOK revalidation. */
(()=>{
'use strict';
const BUILD='11.07-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1107_SINGLE_FLIGHT__';
...
function src(base,attempt){return attempt<=1?base:base+(base.includes('?')?'&':'?')+'noreyo_v1107_retry='+attempt}
...
window.NOREYO_V1107=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{})
})();