/* NOREYO V12.17 bootstrap — V12.15 plus legacy auth-error bridge. */
(()=>{
'use strict';
const BUILD='12.17-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1217_SINGLE_FLIGHT__';
...
function src(base,attempt){return attempt<=1?base:base+(base.includes('?')?'&':'?')+'noreyo_v1217_retry='+attempt}
...
window.NOREYO_V1217=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{})
})();