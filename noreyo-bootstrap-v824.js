...
window.NOREYO_BOOTSTRAP_PRELOAD=Object.freeze({BUILD,SCRIPT_ATTEMPTS,SCRIPT_RETRY_MS,SCRIPT_TIMEOUT_MS,BOOTFETCH,BOOTERROR,GUARD,SHAPE,GENERATION,TRANSPORT,URLBRIDGE,LIFECYCLE,STABILIZER,FAVORITES,FAVORITESAFE,RANKING,PRIORITY,PRIORITYTRUTH,PRIORITYNOTE,PREFSEM,FILTERUX,FILTERVIEW,ADULTAI,CHILDAI,CHILDNATURAL,CHILDMIX,CHILDGATE,TOTALPARTY,TRAVELLERATOMIC,TRAVELLERSTATE,AIRPORTAI,STARTUPSTATE,DATESTATE,AIDATERANGE,NAMEDDATE,NAVSTABILIZER,HOTSTABILIZER,VIEWPORT,PLANNERVIEW,CRUISEVIEW,AIVIEWPORT,AIWIDTH,BASE,retrySrc,loadOnce,load,armDocumentWriteInjection});
boot();
})();