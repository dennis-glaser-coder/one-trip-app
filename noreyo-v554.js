(function(){
  ...
  function loadV578(){
    if(window.NOREYO_V578||document.querySelector('script[data-noreyo-v578]'))return;
    const s=document.createElement('script');
    s.src='./noreyo-v578.js?build=578';
    s.dataset.noreyoV578='1';
    s.defer=true;
    document.head.appendChild(s);
  }

  function loadV579(){
    if(window.NOREYO_V579||document.querySelector('script[data-noreyo-v579]'))return;
    const s=document.createElement('script');
    s.src='./noreyo-v579.js?build=579';
    s.dataset.noreyoV579='1';
    s.defer=true;
    document.head.appendChild(s);
  }

  function loadV580(){
    if(document.querySelector('link[data-noreyo-v580]'))return;
    const l=document.createElement('link');
    l.rel='stylesheet';
    l.href='./noreyo-v580.css?build=580';
    l.dataset.noreyoV580='1';
    document.head.appendChild(l);
  }
  ...
  window.addEventListener('pageshow',()=>{schedule();loadV557();loadV576();loadV577();loadV578();loadV579();loadV580();},{passive:true});
})();
