/* NOREYO V11.55 bootstrap — V11.53 plus Safari BFCache booking-PII scrub. */
(()=>{
'use strict';
const BUILD='11.55-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1155_SINGLE_FLIGHT__';
...
function src(base,attempt){return attempt<=1?base:base+(base.includes('?')?'&':'?')+'noreyo_v1155_retry='+attempt}
...
window.NOREYO_V1155=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{})
})();