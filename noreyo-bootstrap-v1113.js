/* NOREYO V11.13 bootstrap — V11.11 plus hotel PREBOOK final-price delta truth. */
(()=>{
'use strict';
const BUILD='11.13-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1113_SINGLE_FLIGHT__';
...
function src(base,attempt){return attempt<=1?base:base+(base.includes('?')?'&':'?')+'noreyo_v1113_retry='+attempt}
...
window.NOREYO_V1113=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{})
})();