/* NOREYO V11.09 bootstrap — V11.07 plus hotel PREBOOK lifecycle/accessibility. */
(()=>{
'use strict';
const BUILD='11.09-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1109_SINGLE_FLIGHT__';
...
function src(base,attempt){return attempt<=1?base:base+(base.includes('?')?'&':'?')+'noreyo_v1109_retry='+attempt}
...
window.NOREYO_V1109=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{})
})();