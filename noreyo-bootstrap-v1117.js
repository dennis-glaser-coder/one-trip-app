/* NOREYO V11.17 bootstrap — V11.15 plus idempotent hotel acknowledgement reconciliation. */
(()=>{
'use strict';
const BUILD='11.17-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1117_SINGLE_FLIGHT__';
...
function src(base,attempt){return attempt<=1?base:base+(base.includes('?')?'&':'?')+'noreyo_v1117_retry='+attempt}
...
window.NOREYO_V1117=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{})
})();