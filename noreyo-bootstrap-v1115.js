/* NOREYO V11.15 bootstrap — V11.13 plus explicit hotel price-change acknowledgement. */
(()=>{
'use strict';
const BUILD='11.15-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1115_SINGLE_FLIGHT__';
...
function src(base,attempt){return attempt<=1?base:base+(base.includes('?')?'&':'?')+'noreyo_v1115_retry='+attempt}
...
window.NOREYO_V1115=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{})
})();