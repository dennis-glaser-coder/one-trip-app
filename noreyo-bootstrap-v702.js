/* NOREYO V7.02 bootstrap — installs current request/favorite guards plus final Safari viewport arbitration after the generated app loads. */
(()=>{
'use strict';
const BUILD='7.02-safe',GUARD='./noreyo-v701.js?build=701',FAVORITES='./noreyo-v700.js?build=700',VIEWPORT='./noreyo-v702.js?build=702',BASE='./noreyo-bootstrap-v698.js?build=702';
