/* NOREYO V11.03 bootstrap — V11.01 plus flight-verify provider-route integrity. */
(()=>{
'use strict';
const BUILD='11.03-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1103_SINGLE_FLIGHT__';
...
function src(b,a){return a<=1?b:b+(b.includes('?')?'&':'?')+'noreyo_v1103_retry='+a;}
...
window.NOREYO_V1103=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{});
})();