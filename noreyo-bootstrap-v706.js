/* NOREYO V7.06 bootstrap — installs request integrity, full favorite rollback, strict MUST ranking and final Safari viewport arbitration after the generated app loads. */
(()=>{
'use strict';
const BUILD='7.06-safe',GUARD='./noreyo-v705.js?build=705',FAVORITES='./noreyo-v703.js?build=703',RANKING='./noreyo-v706.js?build=706',VIEWPORT='./noreyo-v702.js?build=702',BASE='./noreyo-bootstrap-v698.js?build=706';
