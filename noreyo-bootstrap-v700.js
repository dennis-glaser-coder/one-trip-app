/* NOREYO V7.00 bootstrap — keeps V6.99 Request validation and installs transactional favorite safety after the generated app loads. */
(()=>{
'use strict';
const BUILD='7.00-safe',GUARD='./noreyo-v699.js?build=699',FAVORITES='./noreyo-v700.js?build=700',BASE='./noreyo-bootstrap-v698.js?build=700';
