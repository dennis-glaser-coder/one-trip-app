/* NOREYO V11.05 bootstrap — V11.03 plus hotel no-availability normalization. */
(()=>{
'use strict';
const BUILD='11.05-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1105_SINGLE_FLIGHT__';
...
function src(b,a){return a<=1?b:b+(b.includes('?')?'&':'?')+'noreyo_v1105_retry='+a;}
...
window.NOREYO_V1105=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{});
})();