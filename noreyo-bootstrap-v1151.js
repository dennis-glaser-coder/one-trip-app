/* NOREYO V11.51 bootstrap — V11.49 plus phone-safe booking-data form UX. */
(()=>{
'use strict';
const BUILD='11.51-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1151_SINGLE_FLIGHT__';
...
function src(base,attempt){return attempt<=1?base:base+(base.includes('?')?'&':'?')+'noreyo_v1151_retry='+attempt}
...
window.NOREYO_V1151=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{})
})();