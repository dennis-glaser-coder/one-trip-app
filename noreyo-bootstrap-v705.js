/* NOREYO V7.05 bootstrap — installs symmetric request integrity, full favorite rollback and final Safari viewport arbitration after the generated app loads. */
(()=>{
'use strict';
const BUILD='7.05-safe',GUARD='./noreyo-v705.js?build=705',FAVORITES='./noreyo-v703.js?build=703',VIEWPORT='./noreyo-v702.js?build=702',BASE='./noreyo-bootstrap-v698.js?build=705';
...
window.NOREYO_BOOTSTRAP_PRELOAD=Object.freeze({BUILD,GUARD,FAVORITES,VIEWPORT,BASE,armDocumentWriteInjection});
boot();
})();
