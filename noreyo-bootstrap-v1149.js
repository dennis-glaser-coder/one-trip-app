/* NOREYO V11.49 bootstrap — V11.47 plus exact booking-draft provider-term binding. */
(()=>{
'use strict';
const BUILD='11.49-safe',ATTEMPTS=2,RETRY_MS=260,TIMEOUT_MS=15000,READY_TIMEOUT_MS=45000,POLL_MS=25,KEY='__NOREYO_V1149_SINGLE_FLIGHT__';
...
function src(base,attempt){return attempt<=1?base:base+(base.includes('?')?'&':'?')+'noreyo_v1149_retry='+attempt}
...
window.NOREYO_V1149=Object.freeze({BUILD,COMPONENTS,state,run});run().catch(()=>{})
})();